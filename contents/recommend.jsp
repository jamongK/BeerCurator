...
<body>
	<%
		...
		int bitterness = 0;
		if (session.getAttribute("bitterness") != null) {
			bitterness = (int) session.getAttribute("bitterness");
		}
		
		int maltiness = 0;
		if (session.getAttribute("maltiness") != null) {
			maltiness = (int) session.getAttribute("maltiness");
		}
		
		int fizziness = 0;
		if (session.getAttribute("fizziness") != null) {
			fizziness = (int) session.getAttribute("fizziness");
		}
	%>
	...
	<main>
        <h1>맥주 추천</h1>
		<form action="recommendAction.jsp" method="get">
			<div class="col-auto my-1">
				<label class="mr-sm-2" for="bitternessSelect">쓴 맛</label>
				<select name="bitterness" class="custom-select mr-sm-2" id="bitternessSelect">
					<option selected value="0">쓴 맛 정도..</option>
			...
			<div class="col-auto my-1">
				<label class="mr-sm-2" for="maltinessSelect">맥아 맛</label>
				<select name="maltiness" class="custom-select mr-sm-2" id="maltinessSelect">
					<option selected value="0">맥아 맛 정도..</option>
					<option value="1">약</option>
					<option value="2">중</option>
					<option value="3">강</option>
				</select>
			...
			<div class="col-auto my-1">
				<label class="mr-sm-2" for="fizzinessSelect">탄산</label>
				<select name="fizziness" class="custom-select mr-sm-2" id="fizzinessSelect">
					<option selected value="0">탄산 정도..</option>
					<option value="1">약</option>
					<option value="3">강</option>
				</select>
			</div>
			<input type="submit" value="완료" class="btn btn-primary btn-lg rc-btn">
		</form>
		<div class="recommend-section">
		<%
			if (bitterness == 0) {
		%>
			<div class="bitterness-section">
			
			</div>
		<%
			} else if (bitterness == 1) {
		%>
			<div class="bitterness-section">
			<h4>쓴 맛 기준 추천 맥주 - 약</h4>
				<div class="card">
		...
		<h4>쓴 맛 기준 추천 맥주 - 강</h4>
			...
			<div class="card">
				<h5 class="card-header">
					<a href="typeView.jsp?typeID=6">쾰쉬 &nbsp; Kölsch</a>
				</h5>
				<div class="card-body">
					<img class="card-img-top" src="../img/types/kolsch.png"
						alt="Card image cap">
					<hr>
			...
			<div class="card">
				<h5 class="card-header">
					<a href="typeView.jsp?typeID=10">스타우트 &nbsp; Stout</a>
				</h5>
				<div class="card-body">
					<img class="card-img-top" src="../img/types/stout.png"
						alt="Card image cap">
					<hr>
			...
			<div class="card">
				<h5 class="card-header">
					<a href="typeView.jsp?typeID=14">인디안페일에일 &nbsp; IPA</a>
				</h5>
				<div class="card-body">
					<img class="card-img-top" src="../img/types/IPA.png"
						alt="Card image cap">
					<hr>
		...
		<%
			if (maltiness == 0) {
		%>
			<div class="maltiness-section">
			</div>
		<%
			} else if (maltiness == 1) {
		%>
			<div class="maltiness-section">
			<h4>맥아 맛 기준 추천 맥주 - 약</h4>
				<div class="card">
	                <h5 class="card-header"><a href="typeView.jsp?typeID=8">바이젠 &nbsp; Weizenbier</a></h5>
	                <div class="card-body">
	                    <img class="card-img-top" src="../img/types/weiss.png" alt="Card image cap">
		...
		%>
			<div class="maltiness-section">
			<h4>맥아 맛 기준 추천 맥주 - 중</h4>
				<div class="card">
					<h5 class="card-header">
						<a href="typeView.jsp?typeID=2">라거 &nbsp; Lager</a>
					</h5>
					<div class="card-body">
						<img class="card-img-top" src="../img/types/lager.png"
							alt="Card image cap">
						<hr>
						<p class="card-text">투명한 황금빛과 강한 탄산감</p>
					</div>
				...
				<div class="card">
					<h5 class="card-header">
						<a href="typeView.jsp?typeID=4">헬레스 &nbsp; Helles</a>
					</h5>
					<div class="card-body">
						<img class="card-img-top" src="../img/types/helles.png"
							alt="Card image cap">
						<hr>
				...
				<div class="card">
					<h5 class="card-header">
						<a href="typeView.jsp?typeID=5">메르첸 &nbsp; Märzen</a>
					</h5>
					<div class="card-body">
						<img class="card-img-top" src="../img/types/marzen.png"
							alt="Card image cap">
						<hr>
				...
				<div class="card">
					<h5 class="card-header">
						<a href="typeView.jsp?typeID=13">페일 에일 &nbsp; Pale Ale</a>
					</h5>
					<div class="card-body">
						<img class="card-img-top" src="../img/types/pale-ale.png"
							alt="Card image cap">
						<hr>
		...
		<%
			if (fizziness == 0) {
		%>
			<div class="fizziness-section">
			</div>
		<%
			} else if (fizziness == 1) {
		%>
			<div class="fizziness-section">
			<h4>탄산감 기준 추천 맥주 - 약</h4>
				<div class="card">
	                <h5 class="card-header"><a href="typeView.jsp?typeID=10">스타우트 &nbsp; Stout</a></h5>
	                <div class="card-body">
	                    <img class="card-img-top" src="../img/types/stout.png" alt="Card image cap">
